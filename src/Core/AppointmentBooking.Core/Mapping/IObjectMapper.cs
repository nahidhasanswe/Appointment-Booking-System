...
public interface IObjectMapper
{
    ...
    /// <summary>
    /// Execute a mapping from the queryable source to the destination object
    /// </summary>
    /// <typeparam name="TSource">Source object</typeparam>
    /// <typeparam name="TDestination">Destination object</typeparam>
    /// <returns>Returns the same <see cref="destination"/> object after mapping operation</returns>
    IQueryable<TDestination> GetProjection<TSource, TDestination>(IQueryable<TSource> source);
}